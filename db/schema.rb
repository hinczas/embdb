...
ActiveRecord::Schema.define(version: 20160905133029) do
  ...
  create_table "movies", force: :cascade do |t|
    ...
    t.text     "actor"
    t.text     "poster"
    t.index ["mformat_id"], name: "index_movies_on_mformat_id"
    t.index ["mlanguage_id"], name: "index_movies_on_mlanguage_id"
    t.index ["msubtitle_id"], name: "index_movies_on_msubtitle_id"
    t.index ["mtype_id"], name: "index_movies_on_mtype_id"
    t.index ["myear_id"], name: "index_movies_on_myear_id"
    t.index ["quality_id"], name: "index_movies_on_quality_id"
    t.index ["threed_id"], name: "index_movies_on_threed_id"
  end
  ...
  create_table "part_pcbs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["part_id"], name: "index_part_pcbs_on_part_id"
    t.index ["pcb_id"], name: "index_part_pcbs_on_pcb_id"
  end
  ...
  create_table "part_projects", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["part_id"], name: "index_part_projects_on_part_id"
    t.index ["project_id"], name: "index_part_projects_on_project_id"
  end
  ...
  create_table "parts_pcbs", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["part_id", "pcb_id"], name: "index_parts_pcbs_on_part_id_and_pcb_id", unique: true
    t.index ["part_id"], name: "index_parts_pcbs_on_part_id"
    t.index ["pcb_id"], name: "index_parts_pcbs_on_pcb_id"
  end
  ...
  create_table "pcb_projects", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer  "quantity"
    t.index ["pcb_id"], name: "index_pcb_projects_on_pcb_id"
    t.index ["project_id"], name: "index_pcb_projects_on_project_id"
  end
