...
class ShoppingListsControllerTest < ActionController::TestCase
  ...
  test "should create shopping_list" do
    assert_difference('ShoppingList.count') do
      post :create, shopping_list: { item_id: @shopping_list.item_id, item_quantity: @shopping_list.item_quantity, item_type: @shopping_list.item_type }
    end
  ...
  test "should update shopping_list" do
    patch :update, id: @shopping_list, shopping_list: { item_id: @shopping_list.item_id, item_quantity: @shopping_list.item_quantity, item_type: @shopping_list.item_type }
    assert_redirected_to shopping_list_path(assigns(:shopping_list))
  end
